...
\emph{Hint: remember strings are lists and you can pattern match on a
  number of characters at the start of a list by nested cons and character patterns.}

\emph{Note: in Q7 and Q8 you defined \texttt{parse}
for \texttt{Item} and \texttt{Direction} which can be used here.}
